    ...
    if(isset($_POST["btnsubmit"]))
{
  ...
  $str1="select * from admin where email='$username' && psw='$pass'";
  //echo $str1;
  ...
  {
    $e1= "<font color='red'>plese enter valid username or password</font>";
  }
}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="register-link m-t-15 text-center">
                                    <p>Don't have account ? <a href="admin/registration.php"> Sign Up Here</a></p>
                                </div>
                                <div class="register-link m-t-15 text-center">
                                    <p> <a href="admin/registration.php">Forgot passw</a></p>
                                </div>
                    </form>
                </div>
            </div>
