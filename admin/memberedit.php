...
$qry="Update member set uname='$uname',pwd='$pwd',fname='$fname',lname='$lname',img='$img',email='$email',contactno='$contactno',height='$height',weight='$weight',dob='$dob' where mid=$mid";
//echo $qry;
...
<div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div>User Name</div>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text"  class="form-control" name="txtheight" value="<?php echo $height; ?>"> 
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text"  class="form-control" name="txtweight" value="<?php echo $weight; ?>">  
            </div>
          </div>
