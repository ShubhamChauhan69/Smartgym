...
{
	$str.="<tr><td>".$row["uname"]."</td><td>".$row["fname"]." ".$row["lname"]."</td><td><img src='image/".$row["img"]."' height='100' width='100'></td><td>".$row["email"]."</td><td>".$row["contactno"]."</td><td>".$row["doj"]."</td><td>".$row["dob"]."</td><td><a href='memberedit.php?Id=".$row["mid"]."'><img src='image/del.png' height='30' width='30'></a></td><td><a href='memberdelete.php?Id=".$row["mid"]."'><img src='image/edit.png' height='30' width='30'></a></td></tr>";
}
